...
- 独立机器：精密组装机、碎岩机、车床
- 改良大机器：原始蒸馏塔、大型研磨塔、大型线材轧机、大型压缩机、大型化学反应釜、大型碎岩机、大型车床、工业合金炉、大型离心机组、大型电解槽、大型提取机、大型温室、海陆畜牧装置
- 超维度等泥土熔炉...的同分异构体

TODO：
- 更多改良机器：
- 更多发电手段：大型燃气涡轮、大型柴油机（8并行，这时在单位时间内产生8倍发电和8倍消耗，T2）、通用化学能引擎（16并行，T3）
- 更多新机制：精密组装兼容装配机、重构聚变堆逻辑、裂变反应堆
- 为了整合包本身定制的独立机器：亨特钠反应釜、戴森球系统、太空电梯、超维度等离子锻炉（DTPF）、硅岩反应堆
